  ...
  return (
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-24">
      <div className="text-center mb-16">
        <h1 className="text-3xl font-bold tracking-tight text-gray-900 dark:text-white mb-4">Contact Us</h1>
        <p className="text-gray-600 dark:text-gray-300">Have a question or want to learn more about our products? Reach out to us directly.</p>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
        <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-8 text-center flex flex-col items-center">
          <div className="w-12 h-12 bg-white dark:bg-gray-900 rounded-full flex items-center justify-center shadow-sm mb-4">
            <Phone className="w-5 h-5 text-gray-900 dark:text-white" />
          </div>
          <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-2">Phone / WhatsApp</h3>
          <p className="text-gray-600 dark:text-gray-300 mb-4">Available during business hours for quick support.</p>
          <a href="tel:03158330069" className="text-xl font-semibold text-gray-900 dark:text-white hover:text-gray-600 dark:text-gray-300 transition-colors mb-4 block">
            0315 833 0069
          </a>
        ...
        <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-8 text-center flex flex-col items-center">
          ...
          <p className="text-gray-600 dark:text-gray-300 mb-4">Send us an email and we'll get back to you within 24 hours.</p>
          <a href="mailto:fostorio34@gmail.com" className="text-lg font-semibold text-gray-900 dark:text-white hover:text-gray-600 dark:text-gray-300 transition-colors">
