  ...
  return (
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-24">
      <div className="text-center mb-16">
        <h1 className="text-4xl font-bold tracking-tight text-gray-900 dark:text-white mb-6">About Crafted.</h1>
      ...
      <div className="aspect-[21/9] w-full bg-gray-100 dark:bg-gray-800 rounded-2xl overflow-hidden mb-16">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-24">
        <div>
          <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">Our Philosophy</h2>
        ...
        <div>
          <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">The Maker</h2>
          <p className="text-gray-600 dark:text-gray-300 mb-6 leading-relaxed">
          ...
          <Link to="/products" className="inline-flex items-center text-gray-900 dark:text-white font-medium hover:underline hover:underline-offset-4">
